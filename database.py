...
class Report:
    ...
    def store_patient_details(self, patientId, patientName, age, gender, profilePicture):
        ...
        try:
            ...
            cursor.execute(query, (patientId, patientName, age, gender, profilePicture_binary))
            conn.commit()
            cursor.close()
            conn.close()
        except Exception as e:
    ...
    def store_report(self, patient_id, date, report_id, report):
        ...
        try:
            ...
            cursor.execute(query, (patient_id, date, report_id, report_binary))
            conn.commit()
            cursor.close()
            conn.close()
            # print("it worked bbg")
